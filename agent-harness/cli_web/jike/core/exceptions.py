...
class RateLimitError(JikeError):
...
class NotFoundError(JikeError):
    """Resource not found (HTTP 404)."""


class RPCError(JikeError):
...
def _error_code_for(exc: JikeError) -> str:
